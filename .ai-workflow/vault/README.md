...
This directory stores non-canonical run documents and receipts.

`vault/` is not canonical knowledge. It exists for handoff, provenance, auditability, and human context.

- `shapes/` stores required shape documents used by `px-implement`
